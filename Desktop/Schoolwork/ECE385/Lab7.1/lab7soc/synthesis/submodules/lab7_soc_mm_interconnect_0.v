...
module lab7_soc_mm_interconnect_0 (
		...
		input  wire        hex_digits_pio_reset_reset_bridge_in_reset_reset,   // hex_digits_pio_reset_reset_bridge_in_reset.reset
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                                    //                      clk.clk
		.reset                  (hex_digits_pio_reset_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                      //             clk.clk
		.reset                   (hex_digits_pio_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_router_012 router_012 (
	...
	lab7_soc_mm_interconnect_0_cmd_mux_010 cmd_mux_010 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (hex_digits_pio_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_rsp_demux_010 rsp_demux_010 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (hex_digits_pio_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                    // in_clk_0.clk
		.in_rst_0_reset (hex_digits_pio_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
